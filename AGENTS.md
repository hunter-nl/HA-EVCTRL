...
This is the EV & P1 controller integration for Home Assistant.
...
- Mirror patterns from existing integration modules under `custom_components/ha_evctrl` and tests under `tests`.
