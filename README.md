...
by the session energy. The resulting cost is then rounded normally to two
decimal places. Create both helpers with a price per kWh in EUR before using
the session-cost sensor.
